...
func init() {
	...
	viper.SetDefault(SubchainQueue, "0x0293801741ceF9465b2cf717578e57255863E8B2")
	viper.SetDefault(BridgeCore, "0xa6115196F79E6ee3B7990D3e0AcA0c3627C43743")
	...
	viper.SetDefault(CfgMainchainEthRpcURL, "https://eth-rpc-api-testnet.thetatoken.org/rpc")
	...
	viper.SetDefault(CfgSubchainID, 345612)
}
