...
// Subchain queuefunction returns the key for looking up the address of the 
// Subchain queuefunction deployed in the genesis block
func SubchainQueueFunctionAddressKey() common.Bytes {
	return common.Bytes("ls/sqfa")
}
