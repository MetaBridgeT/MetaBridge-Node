...
var ProxyContractMetaData = &bind.MetaData{
	ABI: "[{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"Received\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"useradd\",\"type\":\"address\"}],\"name\":\"createAccountAbstraction\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"deposit\",\"outputs\":[],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"target\",\"type\":\"address\"},{\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\"},{\"internalType\":\"uint256\",\"name\":\"value\",\"type\":\"uint256\"},{\"internalType\":\"bytes\",\"name\":\"signature\",\"type\":\"bytes\"},{\"internalType\":\"uint256\",\"name\":\"nonce\",\"type\":\"uint256\"}],\"name\":\"execute\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"success\",\"type\":\"bool\"},{\"internalType\":\"bytes\",\"name\":\"returnData\",\"type\":\"bytes\"}],\"stateMutability\":\"payable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"useradd\",\"type\":\"address\"}],\"name\":\"getaccount\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"userToAccountFactory\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
// Getaccount is a free data retrieval call binding the contract method 0x3629da54.
//
// Solidity: function getaccount(address useradd) view returns(address)
func (_ProxyContract *ProxyContractCaller) Getaccount(opts *bind.CallOpts, useradd common.Address) (common.Address, error) {
	var out []interface{}
	err := _ProxyContract.contract.Call(opts, &out, "getaccount", useradd)
...
//
// Solidity: function getaccount(address useradd) view returns(address)
func (_ProxyContract *ProxyContractSession) Getaccount(useradd common.Address) (common.Address, error) {
	return _ProxyContract.Contract.Getaccount(&_ProxyContract.CallOpts, useradd)
}

// Getaccount is a free data retrieval call binding the contract method 0x3629da54.
//
// Solidity: function getaccount(address useradd) view returns(address)
func (_ProxyContract *ProxyContractCallerSession) Getaccount(useradd common.Address) (common.Address, error) {
	return _ProxyContract.Contract.Getaccount(&_ProxyContract.CallOpts, useradd)
}

// UserToAccountFactory is a free data retrieval call binding the contract method 0xb873167a.
//
// Solidity: function userToAccountFactory(address ) view returns(address)
func (_ProxyContract *ProxyContractCaller) UserToAccountFactory(opts *bind.CallOpts, arg0 common.Address) (common.Address, error) {
	var out []interface{}
	err := _ProxyContract.contract.Call(opts, &out, "userToAccountFactory", arg0)
...
//
// Solidity: function userToAccountFactory(address ) view returns(address)
func (_ProxyContract *ProxyContractSession) UserToAccountFactory(arg0 common.Address) (common.Address, error) {
	return _ProxyContract.Contract.UserToAccountFactory(&_ProxyContract.CallOpts, arg0)
}

// UserToAccountFactory is a free data retrieval call binding the contract method 0xb873167a.
//
// Solidity: function userToAccountFactory(address ) view returns(address)
func (_ProxyContract *ProxyContractCallerSession) UserToAccountFactory(arg0 common.Address) (common.Address, error) {
	return _ProxyContract.Contract.UserToAccountFactory(&_ProxyContract.CallOpts, arg0)
}

// CreateAccountAbstraction is a paid mutator transaction binding the contract method 0xc0ae5849.
//
// Solidity: function createAccountAbstraction(address useradd) returns(address)
func (_ProxyContract *ProxyContractTransactor) CreateAccountAbstraction(opts *bind.TransactOpts, useradd common.Address) (*types.Transaction, error) {
	return _ProxyContract.contract.Transact(opts, "createAccountAbstraction", useradd)
}

// CreateAccountAbstraction is a paid mutator transaction binding the contract method 0xc0ae5849.
//
// Solidity: function createAccountAbstraction(address useradd) returns(address)
func (_ProxyContract *ProxyContractSession) CreateAccountAbstraction(useradd common.Address) (*types.Transaction, error) {
	return _ProxyContract.Contract.CreateAccountAbstraction(&_ProxyContract.TransactOpts, useradd)
}

// CreateAccountAbstraction is a paid mutator transaction binding the contract method 0xc0ae5849.
//
// Solidity: function createAccountAbstraction(address useradd) returns(address)
func (_ProxyContract *ProxyContractTransactorSession) CreateAccountAbstraction(useradd common.Address) (*types.Transaction, error) {
	return _ProxyContract.Contract.CreateAccountAbstraction(&_ProxyContract.TransactOpts, useradd)
}
...
// Execute is a paid mutator transaction binding the contract method 0xf1c2ae7f.
//
// Solidity: function execute(address target, bytes data, uint256 value, bytes signature, uint256 nonce) payable returns(bool success, bytes returnData)
func (_ProxyContract *ProxyContractTransactor) Execute(opts *bind.TransactOpts, target common.Address, data []byte, value *big.Int, signature []byte, nonce *big.Int) (*types.Transaction, error) {
	return _ProxyContract.contract.Transact(opts, "execute", target, data, value, signature, nonce)
}

// Execute is a paid mutator transaction binding the contract method 0xf1c2ae7f.
//
// Solidity: function execute(address target, bytes data, uint256 value, bytes signature, uint256 nonce) payable returns(bool success, bytes returnData)
func (_ProxyContract *ProxyContractSession) Execute(target common.Address, data []byte, value *big.Int, signature []byte, nonce *big.Int) (*types.Transaction, error) {
	return _ProxyContract.Contract.Execute(&_ProxyContract.TransactOpts, target, data, value, signature, nonce)
}

// Execute is a paid mutator transaction binding the contract method 0xf1c2ae7f.
//
// Solidity: function execute(address target, bytes data, uint256 value, bytes signature, uint256 nonce) payable returns(bool success, bytes returnData)
func (_ProxyContract *ProxyContractTransactorSession) Execute(target common.Address, data []byte, value *big.Int, signature []byte, nonce *big.Int) (*types.Transaction, error) {
	return _ProxyContract.Contract.Execute(&_ProxyContract.TransactOpts, target, data, value, signature, nonce)
}
